...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/covdefaults-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15039&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/covdefaults-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `covdefaults` can be installed with:

```
conda install covdefaults
```

It is possible to list all of the versions of `covdefaults` available on your platform with:
